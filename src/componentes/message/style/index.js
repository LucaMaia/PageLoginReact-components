...
.br-message {
  ...
  .br-message.inverted.is-warning, .br-message.inverted.warning, .br-message.inverted[warning] {
  ...
  .feedback.inverted.is-warning, .feedback.inverted.warning, .feedback.inverted[warning] {
    --color: var(--color-light);
    --color-rgb: var(--color-light-rgb);
    --color-hsl: var(--color-light-hsl);
    --text-color: var(--color);
